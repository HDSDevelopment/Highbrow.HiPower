...
namespace Highbrow.HiPower.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public async Task<IActionResult> UpdatePost(Department department)
        {
            ServiceResult result = ServiceResult.Failure;
        ...
        public async Task<IActionResult> List()
        {
            ...
            try
            {
                allDepartments = await _departmentService.List();
                
                if(allDepartments != null)
            {
                DepartmentListViewModel listViewModel = new DepartmentListViewModel();
                
                listViewModel.ActiveDepartments = await _departmentService.ListActiveDepartments();
                listViewModel.InactiveDepartments = await _departmentService.ListInactiveDepartments();
                
                listViewModel.ActiveCount = await _departmentService.GetActiveCount();
                listViewModel.InactiveCount = await _departmentService.GetInactiveCount();              
